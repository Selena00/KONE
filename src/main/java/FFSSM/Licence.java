...
public class Licence {
    ...
    public boolean estValide(Calendar d) {
        ...
        //row new UnsupportedOperationException("Pas encore implémenté");
        if (d==null)
           throw new IllegalArgumentException("La Date incorrecte !");
        Calendar da = (Calendar) delivrance.clone();
        da.add(Calendar.YEAR,1);
